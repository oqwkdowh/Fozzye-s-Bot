...
export declare const unixTimestampSeconds: (d?: Date | number | string) => number;
...
export declare const fetchLatestBaileysVersion2: (options?: RequestInit) => Promise<{
    version: WAVersion;
    isLatest: boolean;
    error?: undefined;
} | {
...
export declare const fetchAlphaWaWebVersion: (options?: RequestInit) => Promise<{
    version: WAVersion;
    isLatest: boolean;
    error?: undefined;
} | {
