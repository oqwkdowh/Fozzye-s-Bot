import { QueryIds, QueryIdd, XWAPaths } from '../Types/index.js';
import { generateProfilePicture } from '../Utils/messages-media.js';
import { S_WHATSAPP_NET, isJidNewsletter, getBinaryNodeChild, getBinaryNodeChildString } from '../WABinary/index.js';
...
export const makeNewsletterSocket = (config) => {
    ...
    const getSubscribedNewsletters = async () => {
        ...
        return json.data.xwa2_newsletter_subscribed.map((v) => extractNewsletterMetadata(v));
    };
    ...
    return {
        ...
        newsletterFetchAllParticipating: async () => {
            return await genericExecuteWMexQuery({}, QueryIdd.GETSUBSCRIBED, XWAPaths.xwa2_newsletter_subscribed, query, generateMessageTag);
        },
...
export const extractNewsletterMetadata = (data) => {
    return {
        id: data.id,
        state: data.state,
